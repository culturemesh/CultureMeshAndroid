...
import com.culturemesh.android.models.City;
import com.culturemesh.android.models.Country;
import com.culturemesh.android.models.DatabaseNetwork;
import com.culturemesh.android.models.Event;
import com.culturemesh.android.models.FromLocation;
import com.culturemesh.android.models.Language;
import com.culturemesh.android.models.Location;
import com.culturemesh.android.models.NearLocation;
import com.culturemesh.android.models.Network;
import com.culturemesh.android.models.Place;
import com.culturemesh.android.models.Post;
import com.culturemesh.android.models.PostReply;
import com.culturemesh.android.models.Postable;
import com.culturemesh.android.models.Putable;
import com.culturemesh.android.models.Region;
import com.culturemesh.android.models.User;
...
class API {
    ...
    /**
     * The number of items (e.g. {@link com.culturemesh.android.models.Post}s or {@link Event}s
    ...
    static class Get {
        ...
        /**
         * Get the number of {@link com.culturemesh.android.models.Post}s that are currently
         * on a {@link Network}
         * @param queue Queue to which the asynchronous task will be added
         * @param id ID of the {@link Network} whose {@link com.culturemesh.android.models.Post}
        ...
        /**
         * Get the {@link com.culturemesh.android.models.Post}s a {@link User} has made.
        ...
        static void userPosts(final RequestQueue queue, long id,
                              final Response.Listener<NetworkResponse<ArrayList<com.culturemesh.android.models.Post>>> listener) {
            JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, API_URL_BASE + "user/" +
                    id + "/posts?" + getCredentials(), null, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    final ArrayList<com.culturemesh.android.models.Post> posts = new ArrayList<>();
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            posts.add(new com.culturemesh.android.models.Post(res.getInt("id"), res.getInt("id_user"),
                            ...
                            // listener.
                            instantiatePostUser(queue, posts.get(i), new Response.Listener<com.culturemesh.android.models.Post>() {
                                @Override
                                public void onResponse(com.culturemesh.android.models.Post response) {
                                    ...
                                    if (numReqFin.addAndGet(1) == posts.size()) {
                                        ...
                                        listener.onResponse(new NetworkResponse<ArrayList<com.culturemesh.android.models.Post>>(false, posts));
                                    }
                                }
                            });
                        } catch (JSONException e) {
        ...
        /**
         * Get the {@link com.culturemesh.android.models.Post}s of a {@link Network}
         * @param queue Queue to which the asynchronous task will be added
         * @param id ID of the {@link Network} whose
         * {@link com.culturemesh.android.models.Post}s will be returned
         * @param listener Listener whose {@link com.android.volley.Response.Listener#onResponse(Object)}
         *                 is called with the {@link NetworkResponse} created by the query.
         */
        static void networkPosts(final RequestQueue queue, final long id, String maxId, final Response.Listener<NetworkResponse<List<com.culturemesh.android.models.Post>>> listener) {
            JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, API_URL_BASE + "network/"
                        ...
                        try {
                            ...
                            instantiatePostUser(queue, posts.get(i), new Response.Listener<com.culturemesh.android.models.Post>() {
                                ...
                                public void onResponse(com.culturemesh.android.models.Post response) {
                                    ...
                                    if (numReqFin.addAndGet(1) == posts.size()) {
                                        // We finished!! Call the listener at last.
                                        listener.onResponse(new NetworkResponse<List<com.culturemesh.android.models.Post>>(false, posts));
                                    }
                                }
                            });
                        } catch (JSONException e) {
                            e.printStackTrace();
                            listener.onResponse(new NetworkResponse<List<com.culturemesh.android.models.Post>>(true));
                ...
                public void onErrorResponse(VolleyError error) {
                    int messageID = processNetworkError("API.Get.networkPosts",
                            "ErrorListener for id=" + id, error);
                    listener.onResponse(new NetworkResponse<List<com.culturemesh.android.models.Post>>(true, messageID));
                }
            });
            queue.add(req);
        }
        ...
        /**
         * Get a {@link com.culturemesh.android.models.Post} from it's ID
         * @param queue Queue to which the asynchronous task will be added
         * @param id ID of the {@link com.culturemesh.android.models.Post} to retrieve
         * @param callback Listener whose {@link com.android.volley.Response.Listener#onResponse(Object)}
         *                 is called with the {@link NetworkResponse} created by the query.
         */
        static void post(final RequestQueue queue, long id,
                         final Response.Listener<NetworkResponse<com.culturemesh.android.models.Post>> callback) {
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET,
                    API_URL_BASE + "post/" + id + "?" + getCredentials(),
                    null, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject res) {
                    com.culturemesh.android.models.Post post = null;
                    try {
                        //Make post object out of JSON object.
                        post = new com.culturemesh.android.models.Post(res.getInt("id"), res.getInt("id_user"),
                                res.getInt("id_network"), res.getString("post_text"),
                                res.getString("img_link"), res.getString("vid_link"),
                                res.getString("post_date"));
                        // Now, get author.
                        ...
                        instantiatePostUser(queue, post, new Response.Listener<com.culturemesh.android.models.Post>() {
                            @Override
                            public void onResponse(com.culturemesh.android.models.Post response) {
                                callback.onResponse(new NetworkResponse<com.culturemesh.android.models.Post>(response == null, response));
                            }
                        });
                    } catch (JSONException e) {
                        e.printStackTrace();
                    ...
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        callback.onResponse(new NetworkResponse<com.culturemesh.android.models.Post>(true, null));
                    }
            });
            queue.add(req);
        }
         ...
         */
        static void instantiatePostUser(RequestQueue queue, final com.culturemesh.android.models.Post post,
                                         final Response.Listener<com.culturemesh.android.models.Post> listener) {
            JsonObjectRequest authReq = new JsonObjectRequest(Request.Method.GET,
    ...
    static class Post {
         ...
         * {@link com.culturemesh.android.models.Post}. Success or failure status will be
         * passed via a {@link NetworkResponse<String>} to the listener.
         * @param queue Queue to which the asynchronous task will be added
         * @param post {@link com.culturemesh.android.models.Post} to create.
         * @param listener Listener whose onResponse method will be called when task completes
         */
        static void post(final RequestQueue queue, final com.culturemesh.android.models.Post post,
                         SharedPreferences settings,
                         final Response.Listener<NetworkResponse<String>> listener) {
    ...
    static class Put {
         ...
         * {@link com.culturemesh.android.models.Post}.
         * Success or failure status will be passed via a {@link NetworkResponse<String>} to the
         * listener.
         * @param queue Queue to which the asynchronous task will be added
