...
public class City extends Place {
    ...
    public static City newOnlyMissingRegion(long cityId, long countryId, String cityName,
                                            ...
                                            String featureCode) {
        City c = new City(cityId, Location.NOWHERE, countryId, cityName, NOWHERE, countryName,
